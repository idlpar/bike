...
return [
    "address_1"                      => "Village",
    "address_2"                      => "Father/Husband name",
    "admin"                          => "",
    "city"                           => "Post Office",
    "clerk"                          => "",
    "close"                          => "Close",
    "color"                          => "",
    "comments"                       => "Present Address",
    "common"                         => "common",
    ...
    "software_short"                 => "TARPOR",
    "software_title"                 => "Point of Sale",
    "state"                          => "Thana/Upazilla",
    "submit"                         => "Submit",
    ...
    "website"                        => "tarpor.com",
    "welcome"                        => "Welcome",
    "welcome_message"                => "Welcome to your dashboard, click a module below to get started.",
    "yes"                            => "Yes",
    "you_are_using_ospos"            => "",
    "zip"                            => "Postal Code",
];